...
export const wysiwygToolbarGroups: WysiwygToolbarGroup[] = [
  ...
  { id: 'heading', priority: 62, pinned: true, popover: true, icon: 'i-lucide-heading', label: 'Titres', keys: ['h1', 'h2', 'h3', 'h4', 'h5', 'h6'] },
  { id: 'align', priority: 60, pinned: true, popover: true, icon: 'i-lucide-align-left', label: 'Alignement', keys: ['alignleft', 'aligncenter', 'alignright', 'alignjustify', 'alignnone'] },
